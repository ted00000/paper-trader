#!/usr/bin/env python3
"""
Paper Trading Lab - Production Agent v4.2
RELIABLE PRICE FETCHING using Alpha Vantage API

Changes from v4.0:
- Replaced yfinance with Alpha Vantage (more reliable)
- Works consistently at 4:30 PM after market close
- Free API with 25 calls/day (perfect for 10 stocks)
"""
...
class TradingAgent:
    """Production-ready trading agent with Alpha Vantage price fetching"""
    ...
    def update_portfolio_prices_and_check_exits(self):
        """
        CRITICAL FUNCTION - Updates prices and checks exits
        Uses Alpha Vantage for reliable after-hours pricing
        """
...
"""
    ...
    def execute_analyze_command(self):
        """Execute evening 'analyze' command with Alpha Vantage price fetching"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Paper Trading Lab Agent v4.2")
